...
def insert_github(conn, rows):
    conn.executemany("""
        ...
        (skill, category, date_pulled, total_count, top_repos_avg_stars, top_repos_max_stars)
        VALUES (:skill, :category, :date_pulled, :total_count, :top_repos_avg_stars, :top_repos_max_stars)
    """, rows)
...
def insert_jobs(conn, rows):
    conn.executemany("""
        ...
        (skill, category, date_pulled, job_count)
        VALUES (:skill, :category, :date_pulled, :job_count)
    """, rows)
